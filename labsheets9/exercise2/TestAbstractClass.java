      ...
      public static void main(String args[])
         {
             ...
             Triangle triangle = new Triangle(3.24,4.23,5.78);
             System.out.println("\n\nDetails of Triangle object: \n" + triangle);


             Ellipse ellipse= new Ellipse(5.62,4.19);
             System.out.println("\n\nDetails of Ellipse object: \n" + ellipse);
             ...
             Shape[] allShapes = {circle1,circle2,rectangle1,rectangle2,triangle,ellipse};
